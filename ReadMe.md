...
useRouteMatch is a hook similiar to Route and it can be used instead of Route outside of a switch. it matches the URL exactly  like a Route would.

2. How would you explain form validation to someone who has never programmed before?
think of any signup page on a website, you have to put in a valid email otherwise it will tell you its not a valid email. THis is one aspect of form validation. it validates the info inputted to make sure its acceptable data.

3. In 1-2 sentences, define end to end testing.
its a technique in which you are testing the flow of an application from start to finish. Testing to make sure it is working properly and to identify any issues or deficiencies.
